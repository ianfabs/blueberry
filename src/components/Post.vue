...
export default {
  ...
  computed: {
    ago() {
      let thenDate = new Date(this.postedOn);
      const then = {
        year: thenDate.getFullYear(),
        month: thenDate.getMonth() + 1,
        day: thenDate.getDate(),
        hours: thenDate.getHours(),
        minutes: thenDate.getMinutes(),
        seconds: thenDate.getSeconds()
      };
